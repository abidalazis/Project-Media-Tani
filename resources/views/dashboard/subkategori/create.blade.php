...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambah Subsubkategori</h1>
                ...
                <div class="card-body">
                    <form action="{{ route('subkategori.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_subkategori') is-invalid @enderror" name="nama_subkategori" value="{{ old('nama_subkategori') }}" placeholder="Masukkan Judul Post">
