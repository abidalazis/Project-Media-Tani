                        ...
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square" href="/tambah/keranjang/{{ $item->id }}"><i class="fa fa-shopping-cart"></i></a>
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="/detail/{{ $item->id }}">{{ $item->nama_barang }}</a>
